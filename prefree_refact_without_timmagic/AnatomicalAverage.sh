...
opts_AddMandatory '-o' 'output' 'name' "output basename"

opts_AddOptional '-s' 'StandardImage' 'image' "standard image (e.g. MNI152_T1_2mm)" "$FSLDIR/data/standard/MNI152_T1_2mm.nii.gz"

opts_AddOptional '-m' 'StandardMask' 'image' "standard brain mask (e.g. MNI152_T1_2mm_brain_mask_dil)" "$FSLDIR/data/standard/MNI152_T1_2mm_brain_mask_dil.nii.gz"

#NEEDS TIMS SPECIAL PARSING? 
opts_AddOptional '-b' 'BrainSizeOpt' '' "brain size option"

#NEEDS TIMS SPECIAL PARSING? 
opts_AddOptional '-n' 'crop' 'yes OR no' "do not crop images" "yes"

opts_AddOptional '-w' 'wdir' 'dir' "local, temporary working directory (to be cleaned up - i.e. deleted)" 

#NEEDS TIMS SPECIAL PARSING? 
opts_AddOptional '-noclean' 'cleanup' 'yes OR no' "do not run the cleanup" "yes"

#NEEDS TIMS SPECIAL PARSING? 
opts_AddOptional '-v' 'yes OR no' 'TRUE OR FALSE' "verbose output" "no"
