...
opts_AddMandatory '--template-scene-dual-screen' 'p_TemplateSceneDualScreen' 'path' "template scene file"

opts_AddMandatory '--template-scene-single-screen' 'p_TemplateSceneSingleScreen' 'path' "template scene file"

#NEEDS Tims magic parsing?
opts_AddMandatory '--reuse-high-pass' 'p_ReuseHighPass' 'YES or NO' "Reuse High pass, YES  or  NO"
