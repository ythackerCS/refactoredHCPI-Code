...
opts_AddMandatory '--infmri' 'InputfMRI' '' "input fmri data"

opts_AddMandatory '--biasfield' 'BiasField' '' "bias field or  already registered to fmri data"

opts_AddMandatory '--jacobian' 'Jacobian' '' "jacobian image or  already registered to fmri data"

opts_AddMandatory '--brainmask' 'BrainMask' '' "brain mask in fmri space"

opts_AddMandatory '--ofmri' 'OutputfMRI' '' "output basename for fmri data" "$FSLDIR/bin/remove_ext"

opts_AddMandatory '--usejacobian' 'UseJacobian' '' "apply jacobian modulation: true/false"

opts_AddOptional '--inscout' 'ScoutInput' '' "input name for scout image (pre-sat EPI)"

opts_AddOptional '--oscout' 'ScoutOutput' '' "output name for normalized scout image"

opts_AddOptional '--workingdir' 'Workingdir' '' "working dir" "${OutputfMRI}.wdir"
