...
export HCPPIPEDIR="/media/myelin/Yash/HCPpipelines"
...
export MSMBINDIR="/media/myelin/brainmappers/MSM" ###--- UPDATED THIS LINE ---###
export MATLAB_COMPILER_RUNTIME=/export/matlab/MCR/R2017b/v93
export FSL_FIXDIR=/media/myelin/brainmappers/fix1.06.15 ###--- UPDATED THIS LINE ---###
